...
to_register = [
    ...
    export_operators.HEIO_OT_Export_ModelPointCloud,
    export_operators.HEIO_OT_Export_CollisionPointCloud,
    export_operators.HEIO_OT_Export_ModelPointClouds,
    export_operators.HEIO_OT_Export_CollisionPointClouds,
    ...
    filehandlers.HEIO_FH_ModelPointCloud,
    filehandlers.HEIO_FH_CollisionPointCloud,
    filehandlers.HEIO_FH_ModelPointClouds,
    filehandlers.HEIO_FH_CollisionPointClouds,
