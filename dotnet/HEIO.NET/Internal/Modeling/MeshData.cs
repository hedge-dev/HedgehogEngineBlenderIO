...
{
    public class MeshDataMeshSetInfo
    {
        ...
        public MeshDataMeshSetInfo(bool useByteColors, bool enable8Weights, bool enableMultiTangent, ResourceReference<Material> material, MeshSlot slot, int size)
        {
    ...
    public class MeshDataMeshGroupInfo
    {
        public string Name { get; }
        public int Size { get; internal set; }

        public MeshDataMeshGroupInfo(string name, int size)
        {
            Name = name;
            Size = size;
        }
    ...
    public class MeshData
    {
        ...
        public IList<MeshDataMeshSetInfo> MeshSets { get; set; }

        public IList<MeshDataMeshGroupInfo> Groups { get; set; }
        ...
        public MeshData(
            ...
            Vector4[][] colors,
            MeshDataMeshSetInfo[] meshSets,
            MeshDataMeshGroupInfo[] groups,
            string[]? morphNames)
        {
            Name = name;
            Vertices = vertices;
        ...
        public void ResolveDependencies(IResourceResolver resolver)
        {
            ...
            foreach (MeshDataMeshSetInfo meshSet in MeshSets)
            {
                try
                {
